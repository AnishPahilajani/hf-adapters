...
# so both entry points apply the same default. smoke/unit/integration/
# regression/trunk are literal, first-class values everywhere downstream
# (this repo's Makefile suite-selection case, and every suite job's `if:` in
